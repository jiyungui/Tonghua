...
export const P1Widget = {
  ...
  async render(container, onEditClick) {
    ...
    const bgUrl = await storage.getImageURL('p1_bg_image') || DEFAULT_GRAY_IMAGES.banner;
    const avatarUrl = await storage.getImageURL('p1_avatar_image') || DEFAULT_GRAY_IMAGES.avatar;
        ...
        <div class="p1-image-container">
          ...
          <div class="p1-action-buttons">
            <div class="p1-action-btn">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="#3A3A3C"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>
            </div>
            <div class="p1-action-btn">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#3A3A3C" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
            </div>
            <div class="p1-action-btn">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#3A3A3C" stroke-width="2.5"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
            </div>
          </div>
        </div>
