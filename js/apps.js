...
export const AppsModule = {
  // 第一页 6 个 APP: chat-记忆世界-相册-日记-世界书-老福特
  page1Apps: [
    {
      id: 'chat',
      name: 'chat',
      iconSvg: `
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#1D1D1F" stroke-width="1.8">
    ...
    },
    {
      ...
      name: '老福特',
      iconSvg: `
        <span style="font-family: Georgia, serif; font-size: 22px; font-weight: 800; color: #1D1D1F; letter-spacing: -1px;">L</span>
      `
    }
  ],
